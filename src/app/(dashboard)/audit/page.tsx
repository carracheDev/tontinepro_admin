...
const ACTION_COLOR: Record<string, string> = {
  VALIDER_KYC:      '#2563EB', REJETER_KYC:      '#DC2626',
  VALIDER_RETRAIT:  '#2563EB', REJETER_RETRAIT:  '#DC2626',
  VALIDER_CREDIT:   '#2563EB', REFUSER_CREDIT:   '#DC2626',
  SUSPENDRE_COMPTE: '#DC2626', REACTIVER_COMPTE: '#2563EB',
  VALIDER_PADME:    '#1A56DB', SOUMETTRE_PADME:  '#D97706',
  RESOUDRE_LITIGE:  '#2563EB', REJETER_LITIGE:   '#DC2626',
  RESOUDRE_ALERTE:  '#2563EB',
